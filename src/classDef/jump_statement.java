			...
			else
			{
				...
				if(((returnrecord)child.get(1).record).constant)
				{
					if(first.infinity)
					{
						...
						code.add(new quad("storereturn",tmp,null,ll));
					}
					else
					{
						location l = new location();
				...
				else
				{
					...
					else
					{
						...
						{
							location ll = new location(0,"",0,false,false);
							if(((returnrecord)child.get(1).record).loc.address)code.add(new quad("lal",((returnrecord)child.get(1).record).loc,null,((returnrecord)child.get(1).record).loc));
